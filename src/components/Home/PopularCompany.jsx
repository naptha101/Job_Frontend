...
const PopularCompany = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 mt-6">
      <h2 className="text-4xl font-serif mb-8 text-center font-bold text-gray-800">Popular Companies</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {popularCompanies.map(company => (
          <div
            ...
            key={company.id}
          >
            <img src={company.logo} alt={company.name} className="mx-auto mb-4 w-32 h-32 object-contain" />
            <div>
